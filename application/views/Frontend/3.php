...
<!-- Mirrored from retrina.com/demo/arshia/arshia-plus/webdesigner.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Sep 2023 05:37:10 GMT -->
<head>
    <meta charset="UTF-8">
  ...
  <body class="max-width-d">
    ...
    <?php foreach($profile as $item):?>
      <div class="menu-content-align">
        ...
        <?php foreach($profile as $item):?>
          <a class="download-cv primary-button mt-3 mb-4 d-lg-none" href="<?php echo base_url(). $item->resume_upload; ?>" download>Download CV</a>
          <?php endforeach; ?>
    ...
    <!--  JavaScripts  -->
    <!--  Jquery 3.4.1  -->
    <script data-cfasync="false" src="../../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="<?php echo base_url('assets/Frontend/js/jquery-3.4.1.min.js');?>"></script>
    <!--  Bootstrap Js  -->
