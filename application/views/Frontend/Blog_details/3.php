 ...
 <!--   Right Side Start  -->
    ...
    <div class="left-side  nav-close">
      ...
      <div class="menu-content-align">
        ...
        <a class="download-cv primary-button d-none d-lg-inline-block" href="<?php echo base_url(). $item->resume_upload; ?>">Download CV</a>
    ...
    <?php endforeach; ?>
      ...
      <div class="menu-align">
        ...
        <div class="menu-footer">
            <?php foreach($profile as $item):?>
          <a class="download-cv primary-button mt-3 mb-4 d-lg-none" href="<?php echo base_url(). $item->resume_upload; ?>">Download CV</a>
          <?php endforeach; ?>
